...
export const PricingCard = ({ item, featured = false }) => (
  <GlassPanel className={`h-full px-6 py-7 sm:px-8 ${featured ? 'border-white/22 bg-white/[0.08]' : 'bg-white/[0.04]'}`}>
    ...
    <div className="relative z-10 flex h-full flex-col">
      <div className="sm:min-h-[10.75rem]">
      ...
      <p className="mt-6 rounded-[18px] border border-white/10 bg-black/10 px-4 py-3 text-sm leading-6 text-pearl/86 sm:min-h-[5.75rem]">
        {item.bestFor}
      </p>
